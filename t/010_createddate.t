...
$record->write(no_alerts => 1);
is($record->fields->{$created->id}->as_string, '2014-01-01 12:00:00', "Record created time correct");
is($record->fields->{$version->id}->as_string, '2014-06-01 15:00:00', "Record updated time correct");
$record->clear;

$record->find_current_id(1);

is($record->fields->{$version->id}->values->[0]->hour, 14, "Correct hour for daylight saving time");
is($record->fields->{$version->id}->as_string, '2014-06-01 15:00:00', "Correct hour for daylight saving time as display string");
...
$record->write(no_alerts => 1);
is($record->fields->{$created->id}->values->[0]->hour, 16, "Correct hour in datum for daylight saving time");
is($record->fields->{$created->id}->as_string, '2014-06-01 17:00:00', "Record created time display string correct");
is($record->fields->{$version->id}->values->[0]->hour, 16, "Correct hour in version datum for daylight saving time");
is($record->fields->{$version->id}->as_string, '2014-06-01 17:00:00', "Record updated time correct");
$record->clear;
...
is($record->fields->{$version->id}->values->[0]->hour, 16, "Correct hour for daylight saving time");
is($record->fields->{$created->id}->as_string, '2014-06-01 17:00:00', "Record created time display string correct");
is($record->fields->{$created->id}->values->[0]->hour, 16, "Correct created hour for saving time");
is($record->fields->{$version->id}->as_string, '2014-06-01 17:00:00', "Record updated time correct");
