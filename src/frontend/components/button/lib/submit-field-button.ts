 ...
 */
class SubmitFieldButton extends BaseButton {
    type = "btn-js-submit-field";
...
export default function createSubmitFieldButton(element: HTMLElement | JQuery<HTMLElement>) {
