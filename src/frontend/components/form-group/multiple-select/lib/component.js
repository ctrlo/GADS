...
class MultipleSelectComponent extends Component {
  ...
  handleClick() {
    ...
    $selectElmsInNewRow.each((_, selectEl) => {
    ...
    $dateElmsInNewRow.each((_, dateEl) => {
