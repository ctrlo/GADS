...
class SelectComponent extends Component {
  ...
  /**
   * Update an option in the select
   * @param {string} name The name to update the select option to
  ...
  /**
   * Bind an option's click handler
   * @param {*} option The option to bind the handler to
   */
  ...
  /**
   * Reveal the instance of the select
   * @param {*} $option The option to reveal
   */
   ...
   * @param {boolean} bDisable Whether to disable the fields or not
   */
   ...
   * @param {*} newIndex The new index to update the hovered option to
   */
   ...
   * @param {*} option The option to update the checked state of
   */
