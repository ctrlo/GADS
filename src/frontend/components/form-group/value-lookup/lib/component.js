...
class ValueLookupComponent extends Component {
  ...
  /**
   * Get the lookup endpoint
   * @returns {Object} The lookup endpoint and fields
   */
  getLookupEndpoint() {
  ...
  /**
   * Set up the value lookup for a field
 ...
 * @param {JQuery<HTMLElement>} $field The field to add the status message to
 * @param {string} message The message to display
 * @param {boolean} spinner Whether to show a spinner
 * @param {boolean} is_error Whether the message is an error
 */
 ...
 * @param {JQuery<HTMLElement>} $field The field to remove the status message from
 */
