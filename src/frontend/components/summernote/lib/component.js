...
class SummerNoteComponent extends Component {
  /**
   * Create a new summer note component
   * @param {HTMLElement} element The element to attach the summer note component to
   */
  constructor(element) {
    super(element)
    this.initSummerNote()
  ...
  /**
   * Initialize the summer note component
   */
  initSummerNote() {
    const self = this;
  ...
  /**
   * Handle file upload to embed in the editor
