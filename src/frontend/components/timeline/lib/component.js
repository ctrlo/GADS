...
class TimelineComponent extends Component {
  ...
  initTimeline() {
    Promise.resolve().then(() => {
      ...
      /**
       * Update the range in the session
       * @param {object} props The timeline properties
       */
       ...
       * @param {string} from The date/time to use as the lower bound of the timeline
       * @param {string} to The date/time to use as the upper bound of the timeline
       * @param {string} exclusive Whether to exclude the upper bound from the range
       */
  ...
  /**
   * Setup tippy tooltips
   */
  setupTippy() {
    // Shouldn't we be doing this in Popper for consistency?
  ...
  /**
   * Snap to a specific date
   * @param {string} datetime The date/time to snap to
   * @returns {moment.Moment} The snapped date
   */
  snapToDay(datetime) {
   ...
   * @param {*} dataset The dataset to inject the contrasting color into
   */
