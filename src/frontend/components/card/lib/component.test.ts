...
<div class="content-block">
  <div id="target" class="card card--expandable">
    <div class="card__header">
      <button class="card__header-left" type="button" data-bs-toggle="collapse" data-bs-target="#topic" aria-expanded="false"
        aria-controls="topic">
      ...
      <div class="card__header-right">
        ...
        <button class="card__toggle" type="button" data-bs-toggle="collapse" data-bs-target="#topic" aria-expanded="true"
          aria-controls="topic">
