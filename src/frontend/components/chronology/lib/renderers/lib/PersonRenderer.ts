...
/**
 * PersonRenderer is responsible for rendering a person's details into an HTMLDivElement.
 */
export class PersonRenderer implements Renderable<HTMLDivElement> {
    static counter =0;

    /**
     * Creates a new instance of PersonRenderer.
     * @param {Person} person - The person object containing details to render.
     * @constructor
     * @throws {Error} If the provided person is not an instance of Person.
     */
    constructor(private readonly person: Person) {
    }

    /**
     * Renders the person's details into an HTMLDivElement.
     */
