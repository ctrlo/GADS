...
class SortableComponent extends Component {
   ...
   * @param {HTMLElement} element The element to attach the sortable component to
   */
  constructor(element) {
    super(element)
  ...
  /**
   * Handle the click event for adding a new row
   */
  handleClickAdd() {
  ...
  /**
   * Handle the click event for deleting a row
   * @param {JQuery.Event} ev The event object that triggered the click
   */
