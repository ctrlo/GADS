...
export abstract class AppStorage {
    /**
     * Create a new storage instance. This will either be a GadsStorage or a NullStorage, depending on whether the browser supports encryption.
     * @returns A storage object that can be used to store data in the browser. This will be either a GadsStorage or a NullStorage.
     */
    ...
    /**
     * Whether encryption is enabled in the browser
     */
