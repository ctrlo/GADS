...
const DataTimelinePage = () => {
  ...
  var on_move = function(item, callback) {
  ...
  var snap_to_day = function(datetime) {
  ...
  var on_select = function(properties) {
    ...
    if (items.length == 0) {
      ...
      $("#update_href").attr(
        "href",
        "/" + layout_identifier + "/bulk/update/?" + href
      );
      $("#clone_href").attr(
        "href",
        "/" + layout_identifier + "/bulk/clone/?" + href
      );
