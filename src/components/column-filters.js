const setupColumnFilters = (() => {
  ...
  var setupColumnFilters = function(context) {
    $(".column-filter", context).each(function() {
      ...
      var $clearSearchInput = $columnFilter.find(
        ".column-filter__clear-search-input"
      );
      ...
      var renderValues = function() {
        ...
        var sortedAndFilteredValues = sortValues()
          ? _.sortBy(filteredValues, "value")
          : filteredValues;
