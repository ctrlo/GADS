...
__PACKAGE__->add_unique_constraint("calc_unique_ux_layout_text", ["layout_id", "value_text"]);
__PACKAGE__->add_unique_constraint("calc_unique_ux_layout_int", ["layout_id", "value_int"]);
