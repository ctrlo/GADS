...
-- Created on Mon Apr 14 13:17:12 2025
--
;
--
-- Table: alert
...
CREATE TABLE "authentication" (
  ...
  "saml2_surname" text,
  "saml2_groupname" text,
  "saml2_relaystate" character varying(80),
  "enabled" smallint DEFAULT 0 NOT NULL,
  "saml2_unique_id" character varying(80),
  "saml2_nameid" character varying(30),
  "error_messages" text,
  PRIMARY KEY ("id"),
  CONSTRAINT "authentication_ux_saml2_relaystate" UNIQUE ("saml2_relaystate"),
  CONSTRAINT "authentication_ux_saml2_unique_id" UNIQUE ("saml2_unique_id")
);
...
CREATE TABLE "site" (
  ...
  "register_show_provider" smallint DEFAULT 0 NOT NULL,
