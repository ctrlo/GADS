...
-- Created on Fri Sep  4 17:50:03 2026
--
;
--
-- Table: alert
...
CREATE TABLE "calc_unique" (
  ...
  CONSTRAINT "calc_unique_ux_layout_datetime" UNIQUE ("layout_id", "value_datetime"),
...
CREATE TABLE "view" (
  ...
  "is_limit_override" smallint DEFAULT 0 NOT NULL,
  "filter" text,
  "instance_id" integer,
  "created" timestamp,
  "createdby" bigint,
